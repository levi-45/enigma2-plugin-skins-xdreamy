...
# for infobar,
# <widget source="session.Event_Now" render="iBackdropX" position="100,100" size="680,1000" />
# <widget source="session.Event_Next" render="iBackdropX" position="100,100" size="680,1000" />
# <widget source="session.Event_Now" render="iBackdropX" position="100,100" size="680,1000" nexts="2" />
# <widget source="session.CurrentService" render="iBackdropX" position="100,100" size="680,1000" nexts="3" />
# for ch,
# <widget source="ServiceEvent" render="iBackdropX" position="100,100" size="680,1000" nexts="2" />
# <widget source="ServiceEvent" render="iBackdropX" position="100,100" size="185,278" nexts="2" />
# for epg, event
# <widget source="Event" render="iBackdropX" position="100,100" size="680,1000" />
# <widget source="Event" render="iBackdropX" position="100,100" size="680,1000" nexts="2" />
# or put tag -->  path="/media/hdd/backdrop"
from __future__ import print_function
from Components.Renderer.Renderer import Renderer
from Components.Renderer.iBackdropXDownloadThread import iBackdropXDownloadThread
...
class BackdropAutoDB(iBackdropXDownloadThread):
    def __init__(self):
        iBackdropXDownloadThread.__init__(self)
        self.logdbg = None
