...
# <widget source="session.Event_Now" render="iInfoEvents"/>
# <widget source="session.Event_Next" render="iInfoEvents"/>
# <widget source="Event" render="iInfoEvents"/>
...
if os.path.isdir("/media/hdd"):
  ...
  pathLoc = "/media/usb/infos/" 
elif os.path.isdir("/media/mmc"):
  pathLoc = "/media/mmc/infos/"  
