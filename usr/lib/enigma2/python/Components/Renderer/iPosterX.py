...
# for infobar,
# <widget source="session.Event_Now" render="iPosterX" position="100,100" size="185,278" />
# <widget source="session.Event_Next" render="iPosterX" position="100,100" size="100,150" />
# <widget source="session.Event_Now" render="iPosterX" position="100,100" size="185,278" nexts="2" />
# <widget source="session.CurrentService" render="iPosterX" position="100,100" size="185,278" nexts="3" />

# for ch,
# <widget source="ServiceEvent" render="iPosterX" position="100,100" size="185,278" />
# <widget source="ServiceEvent" render="iPosterX" position="100,100" size="185,278" nexts="2" />

# for epg, event
# <widget source="Event" render="iPosterX" position="100,100" size="185,278" />
# <widget source="Event" render="iPosterX" position="100,100" size="185,278" nexts="2" />
# or put tag -->  path="/media/hdd/poster"
from __future__ import print_function
from Components.Renderer.Renderer import Renderer
from Components.Renderer.iPosterXDownloadThread import iPosterXDownloadThread
